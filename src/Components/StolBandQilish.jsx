...
const StolBandQilish = () => {
  ...
  return (
    <div className="containerb">
      <div className="grid grid-cols-2 gap-10  p-20 rounded-2xl bg-[#181818] max-middle_screen:grid-cols-1 max-md:text-center max-md:p-10">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full border-2 px-5 py-4 rounded-2xl bg-orange shadow-lg shadow-orange text-white text-xl font-semibold uppercase max-middle_screen:w-3/4 max-md:w-3/4 max-sm:w-full max-sm:py-2 max-sm:rounded-md max-sm:text-sm max-sm:tracking-wider"
          >
            Yuborish
          </button>
        </form>
